...
{
    public partial class PackingQtyForm : MaterialForm
    {
        string se_id = null;
        string size_no = null;

        public PackingQtyForm(string vSeId, string vSizeNo)
        {
            InitializeComponent();
            se_id = vSeId;
            size_no = vSizeNo;
        ...
        {
            SJeMES_Framework.Common.UIHelper.UIUpdate(this.Name, this, Program.client, "", Program.client.Language);
            GetPackingQtyDetail(se_id, size_no);
        }

        private void GetPackingQtyDetail(string se_id, string size_no)
        {
